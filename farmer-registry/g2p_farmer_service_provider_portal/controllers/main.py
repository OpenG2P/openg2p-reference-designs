...
class FarmerServiceProviderContorller(ServiceProviderBaseContorller):
    ...
    def portal_home(self, **kwargs):
        ...
        return request.render(
            "g2p_farmer_service_provider_portal.farmer_dashboard_template",
    ...
    def portal_update_suggests(self, **kwargs):
        ...
        return request.render(
            "g2p_farmer_service_provider_portal.farmer_update_suggests_template",
            {
...
class FarmerserviceProviderBeneficiaryManagement(G2PServiceProviderBeneficiaryManagement):
    @http.route(
        ["/get_selection_name"],
        type="http",
        auth="user",
    ...
    def group_create(self, **kw):
        ...
        return request.render(
            "g2p_farmer_service_provider_portal.farmer_create_group_form_template",
            {
    ...
    def group_update(self, _id, **kw):
        try:
            ...
            return request.render(
                "g2p_farmer_service_provider_portal.farmer_update_group_form_template",
                {
                    "relationship_with_hhh": relationship_with_hhh,
                    "group": group,
    ...
    def individual_registrar_create(self, **kw):
        ...
        return request.render(
            "g2p_farmer_service_provider_portal.farmer_individual_registrant_form_template",
            {
                "has_national_id": has_national_id,
                "gender": gender,
                "region": region,
    ...
    def indvidual_update(self, _id):
        try:
            ...
            return request.render(
                "g2p_farmer_service_provider_portal.farmer_individual_registrant_update_form_template",
                {
