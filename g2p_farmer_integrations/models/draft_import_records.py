    ...
    def action_open_map_view(self):
        ...
        try:
            ...
            action = {
                ...
                'view_mode': 'lmap',
                'view_id': self.env.ref('g2p_farmer_integrations.action_partner_map_view').id,
                'target': 'new',
...
class G2PDraftRecord(models.Model):
    ...
    def action_change_state(self):
        return {
            ...
            "view_mode": "form",
            "view_id": self.env.ref("g2p_farmer_integrations.change_state_wizard_view").id,
            "target": "new",
        }
    ...
    def action_open_wizard(self):
        ...
        return {
            ...
            'view_id': self.env.ref('g2p_farmer_integrations.g2p_validation_farmer_form_view').id,
            'target': 'new',
            # 'target': 'current',
